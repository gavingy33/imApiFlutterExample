...
class SendMergerMessage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SendMergerMessageState();
}

class SendMergerMessageState extends State<SendMergerMessage> {
  ...
  sendMergerMessage() async {
    V2TimValueCallback<V2TimMessage> res = await TencentImSDKPlugin.v2TIMManager.getMessageManager().sendMergerMessage(
          msgIDList: msgIDs,
          title: "XXX与XXX的会话",
