...
class SendSoundMessageState extends State<SendSoundMessage> {
  ...
  sendSoundMessage() async {
    int dura = (endTime.millisecondsSinceEpoch - startTime.millisecondsSinceEpoch) ~/ 1000;
    V2TimValueCallback<V2TimMessage> res = await TencentImSDKPlugin.v2TIMManager.getMessageManager().sendSoundMessage(
          soundPath: soundPath,
          duration: dura,
